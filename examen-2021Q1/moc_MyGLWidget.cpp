...
QT_MOC_LITERAL(1, 11, 13), // "actualizaDial"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 1), // "n"
QT_MOC_LITERAL(4, 28, 12), // "cambiaCamara"
QT_MOC_LITERAL(5, 41, 9) // "cambiaPat"

    },
    "MyGLWidget\0actualizaDial\0\0n\0cambiaCamara\0"
    "cambiaPat"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->actualizaDial((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->cambiaCamara(); break;
        case 2: _t->cambiaPat((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::actualizaDial)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::actualizaDial(int _t1)
{
